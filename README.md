...
Export ger en JSON-fil (`smakresan-backup-ÅÅÅÅ-MM-DD.json`) med allt utom API-nyckeln – **nyckeln exporteras aldrig**. Foton är valfria i exporten. Import ersätter all data efter bekräftelse. Ikväll-fliken påminner om senaste exporten är äldre än 30 dagar.
