...
async function askMastaren(chatMessages){
  return callClaude({
    ...
    system:"Du är Mästaren – en varm men rak whiskymentor i appen Pers whiskyresa. "+
...
async function generateTasting(extraWish){
  ...
  return callClaude({
    ...
    system:"Du designar nästa provning i appen Pers whiskyresa. "+journalContext(),
    messages:[{role:"user",content:
